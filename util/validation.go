...
func IsValidOrigin(origin string) (bool, error) {
	...
	res := originHostOnly == "http://localhost" || originHostOnly == "https://localhost" || originHostOnly == "http://127.0.0.1" || originHostOnly == "http://casdoor-authenticator" || strings.HasSuffix(originHostOnly, ".chromiumapp.org") || strings.HasSuffix(originHostOnly, ".julibits.com") || strings.HasSuffix(originHostOnly, ".julibits.cn")
	return res, nil
}
